...
@Data
public class Pager {
	private int totalRows;		//전체 행수 DB에서 가져와야하는 값
	...
	private int pageNo;			//현재 페이지 번호 사용자가 정하는 값
	private int pagesPerGroup;	//그룹당 페이지 수 개발자가 주로 정함
	private int groupNo;		//현재 그룹 번호
	private int rowsPerPage;	//페이지당 행 수 사용자나 개발자가 정함
